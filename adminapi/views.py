...
from adminapi.serializers import AdminSerializer,RouteSerializer,StopSerializer,BusownerviewSerializer,PassengerviewSerializer,CategorySerializer,BusSerializer,BusRouteSerializer,BusRouteStopsSerializer,BusStopDetailSerializer,StopEditSerializer
...
class StopView(ViewSet):    
    ...
    def update(self,request,*args,**kwargs): 
        ...
        serializer=StopEditSerializer(data=request.data,instance=obj)
        if serializer.is_valid():
            serializer.save()
